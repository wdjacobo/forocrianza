                                        ...
                                        <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-start">
                                            ...
                                            <div>
                                                <div class="ms-2 me-auto">
                                                    <form action="<?= url_to('delete-topic', $topic['id']) ?>" method="post" class="col-sm-12 d-flex ms-auto gap-1">
                                                        <input type="hidden" name="_method" value="DELETE">
                                                        <?= csrf_field() ?>

                                                        <a href="<?= url_to('edit-category', $topic['id']) ?>" class="w-100 btn btn-warning btn-lg text-center">Editar</a>
