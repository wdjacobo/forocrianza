    <div class="modal fade" id="aside-modal" tabindex="-1">
                            ...
                            <div
                                ...
                                <?php if ($last_topics !== []): ?>
                                    <div href="#" class="list-group-item pt-3 lh-sm">
                                        <div class="d-flex w-100 align-items-center justify-content-between">
                                            <h5 class="mb-1">Últimos temas</h5>
                                ...
                                <?php if ($topics_with_most_messages !== []): ?>
                                    <div href="#" class="list-group-item py-3 lh-sm">
                                        <div class="d-flex w-100 align-items-center justify-content-between">
                                            <h5 class="mb-1">Temas más comentados</h5> <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#e8eaed">
                                ...
                                <?php if ($trending_subcategories !== []): ?>
                                    <div href="#" class="list-group-item py-3 lh-sm">
                                        <div class="d-flex w-100 align-items-center justify-content-between">
                                            <h5 class="mb-1">Subcategorías populares</h5>
                                            <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#e8eaed">
