    <div class="modal fade bg-primary-lower" id="aside-modal" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <aside class="col p-0">
                        <div
                            class="d-flex flex-column align-items-stretch flex-shrink-0 bg-body-tertiary rounded">
                            <div
                                class="list-group list-group-flush border-bottom scrollarea rounded">
                                <?php if ($last_topics !== []): ?>
                                    <div href="#" class="list-group-item pt-3 lh-sm">
                                        <div class="d-flex w-100 align-items-center justify-content-between">
                                            <h4 class="mb-1">Últimos temas</h4>
                                            <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#699cc9">
                                        ...
                                        <ul class="list-unstyled">
                                            <?php foreach ($last_topics as $topic): ?>
                                                <li class="mb-2"><a href="<?= base_url() . $topic['subcategory_slug'] . "/" .  $topic['topic_slug'] ?>"><?= character_limiter($topic['title'], 60) ?></a></li>
                                            <?php endforeach ?>
                                        </ul>
                                    </div>
                                <?php endif ?>
                                <?php if ($topics_with_most_messages !== []): ?>
                                    <div href="#" class="list-group-item py-3 lh-sm">
                                        <div class="d-flex w-100 align-items-center justify-content-between">
                                            <h4 class="mb-1">Temas más comentados</h4> <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#699cc9">
                                ...
                                <?php if ($trending_subcategories !== []): ?>
                                    <div href="#" class="list-group-item py-3 lh-sm">
                                        <div class="d-flex w-100 align-items-center justify-content-between">
                                            <h4 class="mb-1">Subcategorías populares</h4>
                                            <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#699cc9">
                                        ...
                                        <ul class="list-unstyled">
                                            <?php foreach ($trending_subcategories as $subcategory): ?>
                                                <li class="mb-2"><a href="<?= base_url() . $subcategory['slug'] ?>"><?= character_limiter($subcategory['title'], 60) ?></a></li>
                                            <?php endforeach ?>
                                        </ul>
                                    </div>
                                <?php endif ?>
