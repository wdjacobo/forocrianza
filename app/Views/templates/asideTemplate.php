            ...
            <div class="d-flex flex-column align-items-stretch flex-shrink-0 bg-body-tertiary borde-gris rounded">
                <div class="list-group list-group-flush border-bottom scrollarea rounded">
                    <?php if ($last_topics !== []): ?>
                        <div href="#" class="list-group-item py-3 lh-sm">
                            <div class="d-flex w-100 align-items-center justify-content-between">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="40px" fill="#699cc9" class="mb-3" style="min-width: 36px; max-width:40px">
                    ...
                    <?php if ($topics_with_most_messages !== []): ?>
                        <div href="#" class="list-group-item py-3 lh-sm">
                            <div class="d-flex w-100 align-items-center justify-content-between">
                                <h4 class="mb-2">Más comentados</h4> <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#699cc9" class="mb-3" style="min-width: 36px; max-width:48px">
                    ...
                    <?php if ($trending_subcategories !== []): ?>
                        <div href="#" class="list-group-item py-3 lh-sm">
                            <div class="d-flex w-100 align-items-center justify-content-between">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#699cc9" class="mb-3" style="min-width: 36px; max-width:48px">
