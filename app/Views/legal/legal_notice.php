<div class="container">
    ...
    <div class="row g-5">
                ...
                <div class="list-group list-group-flush scrollarea rounded">
                    ...
                    <div>Contenidos</div>
                        <ul style="list-style-type: none;">
                            <li><a href="#que-informacion-recopilamos">Qué información recopilamos</a></li>
                            <li><a href="#como-utilizamos-la-informacion">Cómo utilizamos la información</a></li>
                            <li><a href="#derechos-y-opciones-como-usuario">Derechos y opciones como usuario</a></li>
                            <li><a href="#cumplimiento-de-la-normativa-europea">Cumplimiento de la normativa europea</a></li>
        ...
        <div class="col-md-7 px-1">
            ...
            <p>Si crea una cuenta en ForoCrianza, su cuenta tendrá un nombre de usuario, un correo electrónico y una contraseña asociados, que almacenaremos en nuestros servidores.

                Cuando usted utiliza Reddit, también puede proporcionar otra información, como una biografía, enlaces a redes sociales, sexo, edad, o ubicación. Esta información es opcional y puede eliminarse en cualquier momento.

                También almacenamos las preferencias y la configuración de su cuenta de usuario. </p>
            ...
            <p class="mb-5">Si le surge cualquier tipo de duda o pregunta o inquietudes sobre nuestra Política de privacidad, puede contactarnos a través de:</p>
            <ul>
