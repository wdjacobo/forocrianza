        ...
        <div class="row g-5">
            ...
            <div class="col-12 col-md-9">
                <h1 class="text-center my-4"><?php
                                                ...
                                                ?></h1>
                <h2 id="que-informacion-recopilamos">Qué información recopilamos</h2>
                ...
                <h3>Contenido no público enviado por usted</h3>
                ...
                <h2 id="como-utilizamos-la-informacion">Cómo utilizamos la información</h2>
                ...
                <h2 id="derechos-y-opciones-como-usuario">Derechos y opciones como usuario</h2>
                ...
                <h3>Acceso y modificación de sus datos</h3>
                ...
                <h2 id="cumplimiento-de-la-normativa-europea">Cumplimiento de la normativa europea</h2>
